...
```
![](./assets/数据结构之链表的应用/GC_all_type.webp)
## 三、经典 GC 算法详解
### 1、copy算法
...
![](./assets/数据结构之链表的应用/copy_top.png)
#### 对象回收
...
![](./assets/数据结构之链表的应用/class_type.png)
...
![](./assets/数据结构之链表的应用/copy_DFS_01.png)
...
![](./assets/数据结构之链表的应用/card_table_page.png)
...
![](./assets/数据结构之链表的应用/card-table-dirty.png)
### 3、G1算法
...
<br>[Tips for Tuning the Garbage First Garbage Collector](https://www.infoq.com/articles/tuning-tips-G1-GC/)
- # 一、概述
  collapsed:: true
	- ![计算器加减法运算](https://www.panziye.com/wp-content/uploads/2022/06/2022061412245367.png)、
...
- # 二、定义
  collapsed:: true
	...
	- ### **抽象语法树：**
		...
		- 用树形来表示符合文法规则的句子（从下往上，从左往右看）：
		  collapsed:: true
			- ![抽象语法树](https://www.panziye.com/wp-content/uploads/2022/06/2022061412270857.png)
- # 三、结构
	- 解释器模式包含以下主要角色。
...
- # 四、Java案例实现
  collapsed:: true
	- **设计实现加减法的软件**
	  collapsed:: true
		- ![解释器模式类图](https://www.panziye.com/wp-content/uploads/2022/06/2022061412324064.png)
	- ## **抽象表达式类**
	  collapsed:: true
		- ```java

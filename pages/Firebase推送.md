		...
		- ### 2、根据不同地区，建立不同推送项目
		  collapsed:: true
			- 1、自己读取json，配置到String里
				- ```xml
				  <!--    海外独立端 beta版本-->
				      <string name="google_app_id_mio_beta" translatable="false">1:1090230266103:android:32c6a945dc11e95b654bf2</string>
				      <string name="project_id_mio_beta" translatable="false">m--live-sg-firebase-beta</string>
				      <string name="api_key_mio_beta" translatable="false">AIzaSyAFCQQN2FPoOTjHIzhYW_tytHeA5hVJ1DU</string>
				  
				  <!--    正式版本-->
				      <string name="google_app_id_mio_prod" translatable="false">1:961708641437:android:387516ce10d34a7430d874</string>
				      <string name="project_id_mio_prod" translatable="false">m-live--sg-firebase-prod</string>
				      <string name="api_key_mio_prod" translatable="false">AIzaSyD-Yij8nkrH3Kx2gPtwFVTKrPfhVUNk7wM</string>
				  ```
			- 2、手动注册
				- ### SDK初始化配置好项目的id
				  collapsed:: true

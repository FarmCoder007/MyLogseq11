...
- # 二、模板方法模式定义
	- [[#red]]==**定义一个操作中的算法骨架**== (比如定义好哪些方法的调用顺序)，
	- 而将[[#red]]==**算法的一些步骤延迟到子类中**==
...
- # 四、模板方法模式Java案例实现：**炒菜**
  collapsed:: true
	- 炒菜的步骤是固定的，分为倒油、热油、倒蔬菜、倒调料品、翻炒等步骤。现通过模板方法模式来用代码模拟。类图如下：
	  collapsed:: true
		- ![模板方法模式类图](https://www.panziye.com/wp-content/uploads/2022/06/2022060408014747.png)
	- ### 代码：
		- ### 抽象类
		  collapsed:: true
			- ```java
			  ...
			  ```
			- 其中倒油、热油、翻炒方法都是基本方法中具体方法，不管炒什么菜都是一样的操作，而倒蔬菜和倒调味料方法都是基本方法中抽象方法，炒不同的菜的这两个方法得具体依据炒什么菜来决定，因此由具体子类去实现，这里没有用到钩子方法，而`cookProcess`是炒菜的具体固定模板方法，设置为final，禁止被子类重写。
		- ### 具体子类-炒手撕包菜类
		  collapsed:: true
			- ```java
		...
		- ### 测试类
			- ```java
			  ...
			  ```
			- ![模板方法模式案例结果](https://www.panziye.com/wp-content/uploads/2022/06/2022060408152253.png)
- # 五、模板方法模式优缺点
  collapsed:: true
	- 优点：

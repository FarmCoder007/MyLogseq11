...
- # 二、策略模式概述
	- 先看下面的图片，我们去旅游选择出行模式有很多种，可以骑自行车、可以坐汽车、可以坐火车、可以坐飞机。
	  collapsed:: true
		- ![出行方式选择](https://www.panziye.com/wp-content/uploads/2022/06/2022060410130682.png)
	- 作为一个程序猿，开发需要选择一款开发工具，当然可以进行代码开发的工具有很多，可以选择Idea进行开发，也可以使用eclipse进行开发，也可以使用其他的一些开发工具。
	  collapsed:: true
		- ![开发工具选择](https://www.panziye.com/wp-content/uploads/2022/06/2022060410134375.png)
- # 三、策略模式结构
	- 策略模式的主要角色如下：
...
- # 四、策略模式Java实例实现
	- **【例】促销活动**
	  collapsed:: true
		...
		- ![策略模式.png](../assets/策略模式_1685674421229_0.png)
	- ## 代码
		- ### 抽象策略类
		  collapsed:: true
			- 定义百货公司所有促销活动的共同接口
